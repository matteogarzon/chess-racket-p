...
- Implemented the function 'move-one-forward?' that checks if the piece can move one square forward.

- Implemented the function 'move-two-forward?' that checks if the piece can move two squares forward, like the pawn in its first move.

- Implemented the function 'move-left-diagonal?' That checks if the piece can move diagonally to the left.

- Implemented the function 'move-right-diagonal?' That checks if the piece can move diagonally to the right.
...
- Implemented the function `checkmate` that checks if a move results in a checkmate and so if the game ends according to that.

- Implemented the function `can-move-two-right?` that checks if a piece can move two squares to the right.

- Implemented the function `can-move-two-left?` that checks if a piece ca move two square to the left.

- Implemented the function `can-castle-right?` that checks if the king can castle to the right.

- Implemented the function `can-castle-left?` that checks if the king can castle to the left.

- Implemented the function `castling` that allows castling when possible.

- Implemented the function `move-one-forward` that allows the piece to move one square forward.

- Implemented the function `move-left-diagonal` that allows the piece to move diagonally to the left.

- Implemented the function `move-right-diagonal` that allows the piece to move diagonally to the right.